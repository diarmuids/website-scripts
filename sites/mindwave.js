// Last updated: 2026-09-14 17:59:14
...
function initMindwavePricingNavigation() {
  ...
  if (!document.getElementById('mindwave-pricing-navigation-styles')) {
    ...
    style.textContent = `
      .section_pricing-nav {
        position: sticky;
        top: var(--mindwave-header-height, 0px);
        z-index: 20;
        opacity: 1;
      ...
      .section_pricing-nav .pricing_nav::-webkit-scrollbar {
        display: none;
      }
  ...
  function updatePricingNavigation() {
    ...
    updateActivePricingNavLink(stickyTop + pricingNavHeight + 24);
  }
...
function initMindwavePage() {
  ...
  initMindwaveFaqKeyboard();
  initMindwavePulse();
  initMindwaveMotivationTabs();
  initMindwaveServiceWhyFade();
}
